...
namespace AngularApp1.Server.Controllers
{
	...
	public class userController : ControllerBase
	{
        ...
        //         if (Passwordhasher.VerifyPassword(user,userobj.Password, user.Password))
        //         {
        ...
        public async Task<IActionResult> Authenticate([FromBody] User userObj)
        {
            ...
            var user = await _appdbcontext.Users
                .FirstOrDefaultAsync(x => x.Firstname == userObj.Firstname);
        ...
        // endpoint for authenticating the user registered by asking for login and password
        //[HttpPost("authenticate")]
        //public async Task<IActionResult> Authenticate([FromBody] User userobj)
        //{
        //    if (userobj == null)
        ...
        //    var passwordVerificationResult = Passwordhasher.VerifyPassword(user, userobj.Password, user.Password);
